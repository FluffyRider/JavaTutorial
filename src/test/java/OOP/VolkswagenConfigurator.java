...
public class VolkswagenConfigurator extends MasinaConfigurator {
    ...
    public VolkswagenConfigurator(String marca, String model, Integer an, double pretStandard, double pretFinal,
    ...
    public void infoVolskwagen() {
        infoMasina();
        System.out.println("VLinia de echipare a masinii este: " + linieDeEchipare);
